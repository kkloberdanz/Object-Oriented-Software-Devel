...
public class MatrixTest {
  public static void main(String[] args) {
    ...
    double[][] matrixA = new double[][] {{1,2,3,4},{2,4,6,8},{9,10,11,12}};
    double[][] matrixB = new double[][] {{0.92,-900,44},{1201,18.264,-21.0},{0,0,0}};
    double[][] matrixC = new double[][] {{1.5E-12,-6.034E2},{41.8,-125E-3}};
    ...
    Three.scaleRow(1,10.0);  // scale row 1 by 10
    Three.scaleRow(1,0.1);   // scale row 1 by 1/10
    if (Arrays.equals(Three.getRow(1),matrixC[1])) {
